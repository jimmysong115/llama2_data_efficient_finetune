...
# 加载 positive 和 negative 数据
with open('/gluster_pdc_llm/user/songjielin/extracted_120k_data/iteration1/all_selected_output_iteration_1_second_better.json', 'r') as f:
    positive_data = json.load(f)

with open('/gluster_pdc_llm/user/songjielin/extracted_120k_data/iteration1/all_selected_output_iteration_1_second_worse.json', 'r') as f:
    negative_data = json.load(f)
...
class_weights = torch.tensor([1.0,8.5]).cuda()
...
tokenizer = BertTokenizer.from_pretrained('/gluster_pdc_llm/user/songjielin/extracted_120k_data/bert_iteration_0/results/checkpoint-120')
...
training_args = TrainingArguments(
    output_dir="./results/second_test_1",
...
trainer = WeightedLossTrainer(
    model=BertForSequenceClassification.from_pretrained('/gluster_pdc_llm/user/songjielin/extracted_120k_data/bert_iteration_0/results/checkpoint-120', num_labels=2),
    args=training_args,
