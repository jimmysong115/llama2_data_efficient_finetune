...
with open('/gluster_pdc_llm/user/songjielin/extracted_120k_data/all_selected_output_iteration_0_better.json', 'r') as f:
    positive_data = json.load(f)

with open('/gluster_pdc_llm/user/songjielin/extracted_120k_data/all_selected_output_iteration_0_worse.json', 'r') as f:
...
class_weights = torch.tensor([1.0,7.0]).cuda()
...
training_args = TrainingArguments(
    ...
    logging_steps=10,
    report_to=[],  # 禁用 wandb
    save_total_limit=1  # 最多保留2个checkpoint
)
