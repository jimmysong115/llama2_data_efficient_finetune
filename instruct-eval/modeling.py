...
class LlamaModel(SeqToSeqModel):
    ...
    # tokenizer:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_5%_data/model_output/songjielin/job-0bb6696368bf1206/output/checkpoint-66'
    # model:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_5%_data/model_output/songjielin/job-0bb6696368bf1206/output/checkpoint-66'
    
    model:str = None
    tokenizer:str = None
    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_5%_data/model_output/songjielin/job-0bb6696368bf1206/output/checkpoint-66'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_full_data/model_output/songjielin/job-0bb6696808a0ac0e/output/checkpoint-132'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_15%_data/model_output/songjielin/job-0bb6698782b2cdca/output/checkpoint-198'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_full_data/model_output/songjielin/job-0bb66963e199896f/output/checkpoint-1323'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_20%_data/model_output/songjielin/job-0bb669a14e15b8d3/output'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_20%_data/model_output_second/songjielin/job-0bb669a3eae0ab3e/output/checkpoint-264'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_random_data/model_output_15%/songjielin/job-0bb669b544a63f92/output/checkpoint-198'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_random_data/model_output_20%/songjielin/job-0bb669b5459164fb/output/checkpoint-264'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_non_iteration_bert_1600_data/model_output_15%/songjielin/job-0bb669b52997b82c/output/checkpoint-198'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_non_iteration_bert_1600_data/model_output_20%/songjielin/job-0bb669b5250a4665/output/checkpoint-264'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_complete_random_data/model_output/songjielin/job-0bb669bf8bdb0aef/output/checkpoint-264'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/seletced_non_diversity_data/model_output/songjielin/job-0bb669f4bb9b454f/output/checkpoint-264'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/stanford_alpaca/selected_20%_data_finetune/model_output/songjielin/job-0bb669f76e8902fa/output/checkpoint-120'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/initial_checkpoint/Llama-2-7b-hf'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/WizardLM/selected_20%_data_finetune/model_output/songjielin/job-0bb669fbbb15642d/output/checkpoint-162'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/stanford_alpaca/output_7B_test/songjielin/job-0bb66874d6fca944/output/checkpoint-609'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_20%_data/model_output_1024/songjielin/job-0bb66a453d6ab7f4/output/checkpoint-528'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/WizardLM/selected_full_data/model_output/songjielin/job-0bb66a4591d3ff31/output/checkpoint-3282'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/WizardLM/selected_20%_data_finetune/model_output_2048/songjielin/job-0bb66a5e5eb193da/output/checkpoint-657'

    # model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_60%_data/model_output_1024/songjielin/job-0bb66a5fe7903be3/output/checkpoint-1590'

    model_path:str = '/gluster_pdc_llm/user/songjielin/extracted_120k_data/selected_20%_data/model_output_1024_llama3.1_8b/songjielin/job-0bb66bab88d1138a/output/checkpoint-528'
